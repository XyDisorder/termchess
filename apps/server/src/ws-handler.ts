...
//
// Rather than constructing typed ServerMessage objects (which hits a
// readonly-vs-mutable array incompatibility between GameSnapshot and the
// Zod-inferred schema types), we build plain objects and serialise them.
// This is safe: the runtime shape is identical.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Friendly error messages for well-known DomainError codes
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Handler factory — returns a @fastify/websocket route handler
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Exported dispatch function — used directly in unit tests without a live
