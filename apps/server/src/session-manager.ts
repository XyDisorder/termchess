...
export class SessionManager {
  ...
  // ---------------------------------------------------------------------------
  // Messaging — accepts pre-serialised JSON payloads for maximum flexibility.
  // Callers construct the message objects and serialise them; this layer just
  // routes the strings to the right WebSocket(s).
  // ---------------------------------------------------------------------------
  ...
  startCleanup(intervalMs = 300_000): void {
    ...
    this.cleanupTimer = setInterval(() => {
      // Sessions expire after two intervals of inactivity
